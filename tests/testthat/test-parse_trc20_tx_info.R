query_params <- list(min_timestamp = "1604188800000",
...
test_that("parse_trc20_tx_info returns correct object", {
  ...
  expect_named(tx_info_parsed, c("tx_id",
                                 "tx_type",
                                 "block_timestamp",
                                 "from_address",
                                 "to_address",
  ...
  expect_equal(tx_info_parsed$from_address,
               "TAUN6FwrnwwmaEqYcckffC7wYmbaS6cBiX")
  expect_equal(tx_info_parsed$to_address,
