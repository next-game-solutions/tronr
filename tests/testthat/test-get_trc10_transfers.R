test_that("get_trc10_transfers returns correct objects", {
  ...
  r1 <- get_trc10_transfers(min_timestamp = "1577837400000",
                            max_timestamp = "1577837450000")

  r2 <- get_trc10_transfers(owner_address = "THLLMnsEKEci5e5dJHnW28QQU8AujGhSoK",
                            min_timestamp = "1577837400000",
                            max_timestamp = "1577837450000")
  ...
  expect_equal(unique(r1$token_name), c("Tronix", "AUP", NA, "BitTorrent"))
