#' Get TRC-20 transfers for an account
#'
#' Returns TRC-20 transfer transactions for a user-specified time range
#'
#' @eval function_params(c("address", "contract_address",
...
#'   min_timestamp = "1610000000000",
#'   max_timestamp = "1612333743000"
#' )
#' print(r1)
#'
...
#' )
#' print(r2)
get_trc20_transfers_by_account_address <- function(address,
