...
There are four functions in `tronr` that can be used to query various aspects of the *current* balance of a TRON account. Note that the term "account" here covers both wallet-like accounts *and* smart contracts.
